...
Great for development & release due to its support for many logging destinations & platforms.
  ...
  s.pod_target_xcconfig = {'SWIFT_ACTIVE_COMPILATION_CONDITIONS[config=DEBUG]' => '$(inherited) SWIFTBEAVER_SUPPORTS_DESTINATIONS',
                           'SWIFT_ACTIVE_COMPILATION_CONDITIONS[config=RELEASE]' => '$(inherited) SWIFTBEAVER_SUPPORTS_DESTINATIONS'}
end
